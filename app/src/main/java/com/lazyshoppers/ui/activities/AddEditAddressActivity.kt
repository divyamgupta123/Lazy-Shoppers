...
import com.lazyshoppers.databinding.ActivityAddEditAddressBinding
...
class AddEditAddressActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra(Constants.EXTRA_ADDRESSES_DETAILS)) {
            mAddressDetails = intent.getParcelableExtra(Constants.EXTRA_ADDRESSES_DETAILS)
        }
    ...
    fun addUpdateAddressSuccess() {
        ...
        val notifySuccessMessage: String =
            if (mAddressDetails != null && mAddressDetails!!.id.isNotEmpty()) {
                ...
                resources.getString(R.string.msg_address_add_success)
            }
